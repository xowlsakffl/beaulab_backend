...
final class ApplyKoreanOperationDocumentation extends OperationExtension
{
    ...
    private const PATH_SUMMARIES = [
        ...
        'get staff/hospitals/{hospital}/operation-histories' => '병의원 히스토리 조회',
        ...
        'get staff/hospital-event-ads' => '이벤트 광고 목록 조회',
        'get staff/hospital-event-ads/placements' => '이벤트 광고 위치 옵션 조회',
        'get staff/hospital-event-ads/availability' => '이벤트 광고 예약 가능 구좌 조회',
        'post staff/hospital-event-ads' => '이벤트 광고 등록',
        'patch staff/hospital-event-ads/allow-status' => '이벤트 광고 검수상태 일괄 수정',
        'get staff/hospital-event-ads/{hospitalEventAd}' => '이벤트 광고 상세 조회',
        ...
        'post user/hospital-events/{hospitalEvent}/dbs' => '이벤트 DB 신청',
        'post user/hospital-events/{hospitalEvent}/real-model-dbs' => '리얼모델 DB 신청',
