...
final readonly class CategoryForStaffDto
{
    ...
    public static function fromModel(Category $category): self
    {
        return new self(
            ...
            groupCode: $category->group_code !== null ? (string) $category->group_code : null,
            groupLabel: Category::groupLabel($category->group_code !== null ? (string) $category->group_code : null),
    ...
    private static function simple(Category $category): array
    {
        $data = [
            ...
            'depth' => (int) $category->depth,
            'group_code' => $category->group_code !== null ? (string) $category->group_code : null,
            'group_label' => Category::groupLabel($category->group_code !== null ? (string) $category->group_code : null),
            'name' => (string) $category->name,
            'code' => $category->code,
