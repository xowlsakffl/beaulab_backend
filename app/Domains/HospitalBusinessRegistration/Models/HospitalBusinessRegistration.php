...
/**
 * HospitalBusinessRegistration 역할 정의.
 * 병원 사업자 등록 도메인의 Eloquent 모델로, 테이블 매핑, 관계, 스코프, 상태 상수를 한곳에 모아 도메인 데이터 접근 기준을 제공한다.
 */
final class HospitalBusinessRegistration extends Model
{
    use HasAuditLogs;
