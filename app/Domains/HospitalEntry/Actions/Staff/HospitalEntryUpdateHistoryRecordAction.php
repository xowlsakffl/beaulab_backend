...
final class HospitalEntryUpdateHistoryRecordAction
{
    ...
    private function snapshot(HospitalEntry $entry): array
    {
        return [
            ...
            ], OperationHistoryDisplayValue::lines([$entry->address, $entry->address_detail])),
            ...
            'business_registration_file' => $this->item(
                ...
                OperationHistoryDisplayValue::fileName($entry->businessRegistrationFile?->path),
            ),
            ...
            'license_file' => $this->item(
                ...
                OperationHistoryDisplayValue::fileName($entry->licenseFile?->path),
            ),
