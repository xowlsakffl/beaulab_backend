...
final class HospitalTalkComment extends Model
{
    ...
    {
        return $this->belongsTo(HospitalTalk::class, 'hospital_talk_id');
    }
    ...
    {
        return $this->hasMany(HospitalTalkCommentMention::class, 'hospital_talk_comment_id')
            ->orderBy('id');
    }
    ...
    {
        return HospitalTalkCommentFactory::new();
    }
}
