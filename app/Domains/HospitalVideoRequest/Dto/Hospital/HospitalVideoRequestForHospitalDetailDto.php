...
namespace App\Domains\HospitalVideoRequest\Dto\Hospital;

use App\Domains\Common\Models\Media\Media;
use App\Domains\HospitalVideoRequest\Models\HospitalVideoRequest;

final readonly class HospitalVideoRequestForHospitalDetailDto
{
    ...
    public static function fromModel(HospitalVideoRequest $videoRequest): self
    {
        return new self([
            ...
            'submitted_by_account_id' => $videoRequest->submitted_by_account_id,
