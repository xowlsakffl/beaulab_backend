...
use App\Domains\VideoRequest\Queries\Staff\VideoRequestDeleteForStaffQuery;
use Illuminate\Support\Facades\DB;
use Illuminate\Support\Facades\Gate;

final class VideoRequestDeleteForStaffAction
{
    public function __construct(private readonly VideoRequestDeleteForStaffQuery $query) {}
