...
final class VideoRequestUpdateForStaffQuery
{
    public function update(VideoRequest $videoRequest, array $payload): VideoRequest
    {
        $videoRequest->fill([
            ...
            'source_video_media_id' => array_key_exists('source_video_media_id', $payload) ? $payload['source_video_media_id'] : $videoRequest->source_video_media_id,
            'source_thumbnail_media_id' => array_key_exists('source_thumbnail_media_id', $payload) ? $payload['source_thumbnail_media_id'] : $videoRequest->source_thumbnail_media_id,
