...
final class HospitalUpdateForStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tel' => ['sometimes', 'required', 'string', 'max:50', 'regex:/^[0-9+\-().\s]{6,50}$/'],
            'ad_reception_phone_1' => ['sometimes', 'required', 'string', 'max:13', 'regex:/^(010-\d{4}-\d{4}|010\d{8})$/'],
            'ad_reception_phone_2' => ['nullable', 'string', 'max:13', 'regex:/^(010-\d{4}-\d{4}|010\d{8})$/'],
            'ad_reception_phone_3' => ['nullable', 'string', 'max:13', 'regex:/^(010-\d{4}-\d{4}|010\d{8})$/'],
            ...
            'feature_ids' => ['sometimes', 'required', 'array', 'min:1', 'max:100'],
            'feature_ids.*' => [
                'integer',
                'distinct',
