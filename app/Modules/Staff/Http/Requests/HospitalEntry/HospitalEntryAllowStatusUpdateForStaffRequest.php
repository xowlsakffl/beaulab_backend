...
final class HospitalEntryAllowStatusUpdateForStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ids.*' => ['integer', 'distinct', Rule::exists('hospital_entries', 'id')->whereNull('deleted_at')],
            'allow_status' => ['required', Rule::in(HospitalEntry::allowStatuses())],
            'reason' => [
                Rule::requiredIf(fn (): bool => $this->input('allow_status') === HospitalEntry::ALLOW_REJECTED),
                'string',
                'max:500',
            ],
        ];
