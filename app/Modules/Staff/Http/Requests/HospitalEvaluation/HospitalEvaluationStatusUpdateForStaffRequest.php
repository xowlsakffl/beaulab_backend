...
final class HospitalEvaluationStatusUpdateForStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'ids.*' => [
                'integer',
                'distinct',
                Rule::exists('hospital_evaluations', 'id')->whereNull('deleted_at'),
            ],
            'status' => ['required', Rule::in(HospitalEvaluation::statuses())],
