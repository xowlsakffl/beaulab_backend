...
final class HospitalEventConsultationListForStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'contact_methods.*' => ['string', Rule::in(HospitalEventConsultation::contactMethods())],
            'preferred_times' => ['nullable', 'array'],
            'preferred_times.*' => ['string', Rule::in(HospitalEventConsultation::preferredTimes())],
            'statuses' => ['nullable', 'array'],
            'statuses.*' => ['string', Rule::in(HospitalEventConsultation::statuses())],
            'allow_statuses' => ['nullable', 'array'],
            'allow_statuses.*' => ['string', Rule::in(HospitalEventConsultation::allowStatuses())],
