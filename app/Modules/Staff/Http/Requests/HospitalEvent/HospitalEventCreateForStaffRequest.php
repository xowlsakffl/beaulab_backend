...
final class HospitalEventCreateForStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'procedure_targets' => ['required_if:event_type,TEXT', 'array', 'min:2', 'max:20'],
            'procedure_targets.*' => ['string', 'max:90'],
            'procedure_benefits' => ['required_if:event_type,TEXT', 'array', 'min:2', 'max:20'],
