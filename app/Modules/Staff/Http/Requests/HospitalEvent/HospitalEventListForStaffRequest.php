...
final class HospitalEventListForStaffRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'admin_status.*' => [Rule::in(HospitalEvent::adminStatuses())],
            ...
            'date_types.*' => ['string', Rule::in(['event_start_at', 'event_end_at'])],
            'quantity_metric' => ['nullable', 'string', Rule::in(['all', 'view_count'])],
            ...
            'sort' => ['nullable', 'in:id,event_price,discount_rate,view_count,admin_status,allow_status,created_at,updated_at,event_start_at,event_end_at'],
    ...
    public function filters(): array
    {
        ...
        return [
            ...
            'quantity_metric' => $validated['quantity_metric'] ?? 'all',
            'quantity_min' => isset($validated['quantity_min']) ? (int) $validated['quantity_min'] : null,
            'quantity_max' => isset($validated['quantity_max']) ? (int) $validated['quantity_max'] : null,
