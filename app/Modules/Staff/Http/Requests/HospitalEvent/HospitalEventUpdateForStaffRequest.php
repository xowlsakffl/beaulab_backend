...
final class HospitalEventUpdateForStaffRequest extends FormRequest
{
    protected function prepareForValidation(): void
    {
        ...
        foreach (['doctor_assignments', 'options', 'procedure_targets', 'procedure_benefits', 'before_after_photos'] as $key) {
            if (array_key_exists($key, $data)) {
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'manager_staff_id' => ['sometimes', 'nullable', 'integer', Rule::exists('account_staffs', 'id')->whereNull('deleted_at')],
