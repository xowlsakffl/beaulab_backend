...
final class HospitalEventConsultationCreateForUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'contact_method' => ['required', Rule::in(HospitalEventConsultation::contactMethods())],
            'preferred_time' => ['required', Rule::in(HospitalEventConsultation::preferredTimes())],
