...
/**
 * @extends Factory<HospitalTalk>
 */
final class HospitalTalkFactory extends Factory
{
    protected $model = HospitalTalk::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'status' => $this->faker->randomElement([HospitalTalk::STATUS_ACTIVE, HospitalTalk::STATUS_INACTIVE]),
    ...
    public function active(): self
    {
        return $this->state(fn () => [
            'status' => HospitalTalk::STATUS_ACTIVE,
            'is_visible' => true,
        ]);
    }
