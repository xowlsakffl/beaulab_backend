...
return new class extends Migration
{
    ...
    {
        Schema::create('hospital_review_comment_mentions', function (Blueprint $table) {
            $table->id()->comment('병의원 후기 댓글 멘션 ID');
    ...
    {
        Schema::dropIfExists('hospital_review_comment_mentions');
    }
};
